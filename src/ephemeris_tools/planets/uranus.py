...
URANUS_CONFIG = PlanetConfig(
    ...
    rings=[
        RingSpec(
            ...
            _deg(242.80),
            _deg(12.12),
            dperi_dt=URANUS_RING_DPERI[0],
            dnode_dt=URANUS_RING_DNODE[0],
            name='Six',
        ),
        RingSpec(
            42234.82,
            ...
            _deg(170.31),
            _deg(286.57),
            dperi_dt=URANUS_RING_DPERI[1],
            dnode_dt=URANUS_RING_DNODE[1],
            name='Five',
        ),
        RingSpec(
            42570.91,
            ...
            _deg(127.28),
            _deg(89.26),
            dperi_dt=URANUS_RING_DPERI[2],
            dnode_dt=URANUS_RING_DNODE[2],
            name='Four',
        ),
        RingSpec(
            44718.45,
            ...
            _deg(333.24),
            _deg(63.08),
            dperi_dt=URANUS_RING_DPERI[3],
            dnode_dt=URANUS_RING_DNODE[3],
            name='Alpha',
        ),
        RingSpec(
            45661.03,
            ...
            _deg(224.88),
            _deg(310.05),
            dperi_dt=URANUS_RING_DPERI[4],
            dnode_dt=URANUS_RING_DNODE[4],
            name='Beta',
        ),
        RingSpec(
            47175.91,
            ...
            0.0,
            0.0,
            dperi_dt=URANUS_RING_DPERI[5],
            dnode_dt=URANUS_RING_DNODE[5],
            name='Eta',
        ),
        RingSpec(
            47626.87,
            ...
            _deg(132.10),
            0.0,
            dperi_dt=URANUS_RING_DPERI[6],
            dnode_dt=URANUS_RING_DNODE[6],
            name='Gamma',
        ),
        RingSpec(
            48300.12,
            ...
            0.0,
            0.0,
            dperi_dt=URANUS_RING_DPERI[7],
            dnode_dt=URANUS_RING_DNODE[7],
            name='Delta',
        ),
        RingSpec(
            50023.94,
        ...
        RingSpec(
            ...
            _deg(214.97),
            0.0,
            dperi_dt=URANUS_RING_DPERI[9],
            dnode_dt=URANUS_RING_DNODE[9],
            name='Epsilon',
        ),
        RingSpec(
            51207.32,
            ...
            _deg(214.97),
            0.0,
            dperi_dt=URANUS_RING_DPERI[10],
            dnode_dt=URANUS_RING_DNODE[10],
            name='Epsilon',
        ),
        RingSpec(
            66100.0,
            ...
            0.0,
            0.0,
            dperi_dt=URANUS_RING_DPERI[11],
            dnode_dt=URANUS_RING_DNODE[11],
            dashed=True,
            name='Nu',
        ),
        RingSpec(
            ...
            0.0,
            0.0,
            dperi_dt=URANUS_RING_DPERI[12],
            dnode_dt=URANUS_RING_DNODE[12],
            name='Nu',
        ),
        RingSpec(
            69900.0,
            ...
            0.0,
            0.0,
            dperi_dt=URANUS_RING_DPERI[13],
            dnode_dt=URANUS_RING_DNODE[13],
            dashed=True,
            name='Nu',
        ),
        RingSpec(
            ...
            0.0,
            0.0,
            dperi_dt=URANUS_RING_DPERI[14],
            dnode_dt=URANUS_RING_DNODE[14],
            dashed=True,
            name='Mu',
        ),
        RingSpec(
            ...
            0.0,
            0.0,
            dperi_dt=URANUS_RING_DPERI[15],
            dnode_dt=URANUS_RING_DNODE[15],
            name='Mu',
        ),
        RingSpec(
            103000.0,
            ...
            0.0,
            0.0,
            dperi_dt=URANUS_RING_DPERI[16],
            dnode_dt=URANUS_RING_DNODE[16],
            dashed=True,
            name='Mu',
        ),
    ],
