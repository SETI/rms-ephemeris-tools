...
def main() -> int:
    ...
    ephem_parser.add_argument("--cgi", action="store_true", help="Read parameters from environment (CGI)")
    ephem_parser.add_argument("--planet", type=int, choices=[4, 5, 6, 7, 8, 9], default=6,
                             help="Planet number (4=Mars..9=Pluto); env: NPLANET")
    ephem_parser.add_argument("--start", type=str, default="", help="Start time; env: start, START_TIME")
    ephem_parser.add_argument("--stop", type=str, default="", help="Stop time; env: stop, STOP_TIME")
    ...
    ephem_parser.add_argument("--longitude", type=float, default=None, help="Longitude (deg); env: longitude")
    ephem_parser.add_argument("--lon-dir", type=str, default="east", choices=["east", "west"], help="env: lon_dir")
    ephem_parser.add_argument("--altitude", type=float, default=None, help="Altitude (m) when viewpoint=latlon; env: altitude")
    ephem_parser.add_argument("--sc-trajectory", type=int, default=0, help="Spacecraft trajectory version; env: sc_trajectory")
    ephem_parser.add_argument("--columns", type=int, nargs="*", default=None, help="Column IDs; env: columns")
    ephem_parser.add_argument("--mooncols", type=int, nargs="*", default=None, help="Moon column IDs; env: mooncols")
    ephem_parser.add_argument("--moons", type=int, nargs="*", default=None, help="Moon indices (e.g. 1 2 3); env: moons")
    ephem_parser.add_argument("-o", "--output", type=str, default=None, help="Output file; env: EPHEM_FILE")
    ...
    track_parser.add_argument("--planet", type=int, choices=[4, 5, 6, 7, 8, 9], default=6, help="Planet; env: NPLANET")
    ...
    track_parser.add_argument("--longitude", type=float, default=None, help="Longitude (deg); env: longitude")
    track_parser.add_argument("--lon-dir", type=str, default="east", choices=["east", "west"], help="env: lon_dir")
    track_parser.add_argument("--altitude", type=float, default=None, help="Altitude (m); env: altitude")
    track_parser.add_argument("--sc-trajectory", type=int, default=0, help="Spacecraft trajectory; env: sc_trajectory")
    track_parser.add_argument("--moons", type=int, nargs="*", default=None, help="Moon indices (e.g. 1 2 3); env: moons")
    track_parser.add_argument("--rings", type=int, nargs="*", default=None, help="Ring options (e.g. 61 62 for Saturn); env: rings")
    track_parser.add_argument("--xrange", type=float, default=None, help="Half-range of x-axis (arcsec or radii); env: xrange")
    track_parser.add_argument("--xunit", type=str, default="arcsec", choices=["arcsec", "radii"],
                              help="x-axis units; env: xunit")
    track_parser.add_argument("--title", type=str, default="", help="Plot title; env: title")
    track_parser.add_argument("-o", "--output", type=str, default=None, help="PostScript file; env: TRACKER_POSTFILE")
    track_parser.add_argument("--output-txt", type=str, default=None, help="Text table file; env: TRACKER_TEXTFILE")
    ...
    view_parser.add_argument("--fov-unit", type=str, default="deg", choices=["deg", "arcmin", "arcsec"],
                             help="env: fov_unit")
    view_parser.add_argument("--center", type=str, default="body",
                             choices=["body", "ansa", "J2000", "star"], help="Diagram center; env: center")
    view_parser.add_argument("--center-body", type=str, default="", help="Body name when center=body; env: center_body")
    view_parser.add_argument("--center-ansa", type=str, default="", help="Ring ansa when center=ansa; env: center_ansa")
    view_parser.add_argument("--center-ew", type=str, default="east", help="East/west when center=ansa; env: center_ew")
    view_parser.add_argument("--center-ra", type=float, default=0.0, help="Center RA (deg); env: center_ra")
    view_parser.add_argument("--center-dec", type=float, default=0.0, help="Center Dec (deg); env: center_dec")
    view_parser.add_argument("--center-ra-type", type=str, default="hours", help="RA units; env: center_ra_type")
    view_parser.add_argument("--center-star", type=str, default="", help="Star name when center=star; env: center_star")
    view_parser.add_argument("--viewpoint", type=str, default="", help="observatory, latlon, or Earth's Center; env: viewpoint")
    view_parser.add_argument("--observatory", type=str, default="", help="Observatory name; env: observatory")
    view_parser.add_argument("--latitude", type=float, default=None, help="Latitude (deg); env: latitude")
    view_parser.add_argument("--longitude", type=float, default=None, help="Longitude (deg); env: longitude")
    view_parser.add_argument("--lon-dir", type=str, default="east", choices=["east", "west"], help="env: lon_dir")
    view_parser.add_argument("--altitude", type=float, default=None, help="Altitude (m); env: altitude")
    view_parser.add_argument("--sc-trajectory", type=int, default=0, help="Spacecraft trajectory; env: sc_trajectory")
    view_parser.add_argument("--moons", type=int, nargs="*", default=None, help="Moon indices; env: moons")
    view_parser.add_argument("--moremoons", type=str, default=None, help="Additional moon selection; env: moremoons")
    view_parser.add_argument("--rings", type=int, nargs="*", default=None, help="Ring options; env: rings")
    view_parser.add_argument("--standard", type=str, default=None, help="Standard stars; env: standard")
    view_parser.add_argument("--additional", type=str, default=None, help="Additional star; env: additional")
    view_parser.add_argument("--extra-name", type=str, default=None, help="Additional star name; env: extra_name")
    view_parser.add_argument("--extra-ra", type=str, default=None, help="Additional star RA; env: extra_ra")
    view_parser.add_argument("--extra-ra-type", type=str, default=None, help="Additional star RA type; env: extra_ra_type")
    view_parser.add_argument("--extra-dec", type=str, default=None, help="Additional star Dec; env: extra_dec")
    view_parser.add_argument("--other", type=str, nargs="*", default=None, help="Other bodies; env: other")
    ...
    view_parser.add_argument("--moonpts", type=str, default=None, help="Moon enlargement (points); env: moonpts")
    view_parser.add_argument("--blank", type=str, default=None, help="Blank disks; env: blank")
    view_parser.add_argument("--opacity", type=str, default=None, help="Ring plot type; env: opacity")
    view_parser.add_argument("--peris", type=str, default=None, help="Pericenter markers; env: peris")
    view_parser.add_argument("--peripts", type=str, default=None, help="Pericenter marker size; env: peripts")
    view_parser.add_argument("--meridians", type=str, default=None, help="Prime meridians; env: meridians")
    view_parser.add_argument("--arcmodel", type=str, default=None, help="Arc model (Neptune); env: arcmodel")
    view_parser.add_argument("--arcpts", type=str, default=None, help="Arc weight points (Neptune); env: arcpts")
    view_parser.add_argument("-o", "--output", type=str, default=None, help="PostScript file; env: VIEWER_POSTFILE")
    view_parser.add_argument("--output-txt", type=str, default=None, help="Field of View table file")
...
def _viewer_cmd(parser: argparse.ArgumentParser, args: argparse.Namespace) -> int:
    ...
    out = open(args.output, "w") if getattr(args, "output", None) else None
    out_txt = open(args.output_txt, "w") if getattr(args, "output_txt", None) else None
